...
use crate::filter_coeffs_96000;

pub fn load_filters_96000() -> (CrossoverBiquads,CrossoverBiquads,CrossoverBiquads,CrossoverBiquads,CrossoverBiquads,[f32;6])
{
    ...
    for i in 0..filter_coeffs_96000::FILTER_0_LPF.len()
    {
        filter_0_bq.lpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_0_LPF[i][0],
                    filter_coeffs_96000::FILTER_0_LPF[i][1],
                    filter_coeffs_96000::FILTER_0_LPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_0_LPF[i][4],
                    filter_coeffs_96000::FILTER_0_LPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_0_HPF.len()
    {
        filter_0_bq.hpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_0_HPF[i][0],
                    filter_coeffs_96000::FILTER_0_HPF[i][1],
                    filter_coeffs_96000::FILTER_0_HPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_0_HPF[i][4],
                    filter_coeffs_96000::FILTER_0_HPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_1_LPF.len()
    {
        filter_1_bq.lpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_1_LPF[i][0],
                    filter_coeffs_96000::FILTER_1_LPF[i][1],
                    filter_coeffs_96000::FILTER_1_LPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_1_LPF[i][4],
                    filter_coeffs_96000::FILTER_1_LPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_1_HPF.len()
    {
        filter_1_bq.hpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_1_HPF[i][0],
                    filter_coeffs_96000::FILTER_1_HPF[i][1],
                    filter_coeffs_96000::FILTER_1_HPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_1_HPF[i][4],
                    filter_coeffs_96000::FILTER_1_HPF[i][5]
                ])
            );
    }
    
    /* Filter 2 */
    for i in 0..filter_coeffs_96000::FILTER_2_LPF.len()
    {
        filter_2_bq.lpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_2_LPF[i][0],
                    filter_coeffs_96000::FILTER_2_LPF[i][1],
                    filter_coeffs_96000::FILTER_2_LPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_2_LPF[i][4],
                    filter_coeffs_96000::FILTER_2_LPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_2_HPF.len()
    {
        filter_2_bq.hpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_2_HPF[i][0],
                    filter_coeffs_96000::FILTER_2_HPF[i][1],
                    filter_coeffs_96000::FILTER_2_HPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_2_HPF[i][4],
                    filter_coeffs_96000::FILTER_2_HPF[i][5]
                ])
            );
    }
    
    /* Filter 3 */
    for i in 0..filter_coeffs_96000::FILTER_3_LPF.len()
    {
        filter_3_bq.lpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_3_LPF[i][0],
                    filter_coeffs_96000::FILTER_3_LPF[i][1],
                    filter_coeffs_96000::FILTER_3_LPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_3_LPF[i][4],
                    filter_coeffs_96000::FILTER_3_LPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_3_HPF.len()
    {
        filter_3_bq.hpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_3_HPF[i][0],
                    filter_coeffs_96000::FILTER_3_HPF[i][1],
                    filter_coeffs_96000::FILTER_3_HPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_3_HPF[i][4],
                    filter_coeffs_96000::FILTER_3_HPF[i][5]
                ])
            );
    }

    /* Filter 4 */
    for i in 0..filter_coeffs_96000::FILTER_4_LPF.len()
    {
        filter_4_bq.lpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_4_LPF[i][0],
                    filter_coeffs_96000::FILTER_4_LPF[i][1],
                    filter_coeffs_96000::FILTER_4_LPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_4_LPF[i][4],
                    filter_coeffs_96000::FILTER_4_LPF[i][5]
                ])
            );
    }
    for i in 0..filter_coeffs_96000::FILTER_4_HPF.len()
    {
        filter_4_bq.hpf.push(
            Biquad::new(
                [
                    filter_coeffs_96000::FILTER_4_HPF[i][0],
                    filter_coeffs_96000::FILTER_4_HPF[i][1],
                    filter_coeffs_96000::FILTER_4_HPF[i][2]
                ],
                [
                    filter_coeffs_96000::FILTER_4_HPF[i][4],
                    filter_coeffs_96000::FILTER_4_HPF[i][5]
                ])
            );
    }
